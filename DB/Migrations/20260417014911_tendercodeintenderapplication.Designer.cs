...
namespace DB.Migrations
{
    ...
    [Migration("20260417014911_tendercodeintenderapplication")]
    partial class tendercodeintenderapplication
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DB.EFModel.CategoryCodeApprovalItem", b =>
                {
                    ...
                    b.Property<int>("CategoryCodeApprovalId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CategoryCodeApprovalId");
            ...
            modelBuilder.Entity("DB.EFModel.VendorBank", b =>
                {
                    ...
                    b.Property<string>("FixedDeposit")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DB.Model.MaterialBudget", b =>
                {
                    ...
                    b.Property<string>("RujukanType")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RujukanValue")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DB.EFModel.CategoryCodeApprovalItem", b =>
                {
                    ...
                    b.HasOne("DB.EFModel.CategoryCodeApproval", "CategoryCodeApproval")
                        .WithMany("Items")
                        .HasForeignKey("CategoryCodeApprovalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("CategoryCodeApproval");
